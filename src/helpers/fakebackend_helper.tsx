...
// Login Method
const postJwtLogin = (data: Record<string, unknown>)=> post(url.POST_JWT_LOGIN, data);

// postForgetPwd
const postJwtForgetPwd = (data: Record<string, unknown>) => post(url.POST_FAKE_JWT_PASSWORD_FORGET, data);

// postSocialLogin
// export const postSocialLogin = data => post(url.SOCIAL_LOGIN, data);

// get Products
// export const getProducts = () => useQuerys(productsQuery);
